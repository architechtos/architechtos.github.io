...
Η "Αδεσπολις" είναι μια ανεξάρτητη, ιδιωτική πρωτοβουλία πολιτών που αγαπούν και φροντίζουν αδέσποτα ζώα στην Ξάνθη. Δεν ανήκουμε σε κάποιον επίσημο φορέα ούτε εκπροσωπούμε κάποιον οργανισμό, είμαστε απλώς άνθρωποι που νοιαζόμαστε.

Φτιάξαμε αυτόν τον χώρο για να δώσουμε φωνή στα ζώα που δεν έχουν φωνή, και για να διευκολύνουμε όσους θέλουν να προσφέρουν. Η πλατφόρμα παρέχει εργαλεία για την καταγραφή, τη στήριξη και την καλύτερη φροντίδα των αδέσποτων, με στόχο τη συνεργασία και την αλληλεγγύη σε επίπεδο γειτονιάς.

Αν πιστεύεις κι εσύ πως κάθε ζωή έχει αξία και θέλεις να βοηθήσεις έμπρακτα, η πόλη και οι τετράποδοι φίλοι της σε χρειάζονται. Μαζί μπορούμε να κάνουμε τη διαφορά." 
          </p>
