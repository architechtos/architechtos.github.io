...
const NewsArticle = () => {
  ...
  },
  {
    ...
    {
      id: "4",
      title: "Νέο καταφύγιο ζώων στη Ξάνθη",
      content: "Εγκαινιάστηκε το νέο καταφύγιο ζώων που θα φιλοξενήσει έως 50 αδέσποτα. Το καταφύγιο διαθέτει σύγχρονες εγκαταστάσεις και κτηνιατρείο για την πλήρη φροντίδα των ζώων. Η λειτουργία του καταφυγίου θα στηρίζεται στην εθελοντική εργασία και στις δωρεές των πολιτών.",
      date: "2024-01-08",
