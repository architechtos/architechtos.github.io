...
const ProductsSection = () => {
  ...
  // Demo product if no products exist
  const demoProduct = {
    id: 'demo',
    name: 'Ταΐστρα/Ποτίστρα Αδέσποτων - Μοντέλο A',
    description: 'Χειροποίητη ταΐστρα από ανθεκτικό υλικό, ιδανική για εξωτερικούς χώρους. Αντέχει στις καιρικές συνθήκες και είναι εύκολη στον καθαρισμό.',
    price: 5,
  ...
  const displayProducts = products && products.length > 0 ? products : [demoProduct];
